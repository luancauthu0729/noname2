...
const initWebRouter = (app) => {
    ...
    router.post('/api/webapi/k3/GetPercent', middlewareController, k3Controller.GetPercent); // register
    ...
    router.post('/admin/manager/settings/k3', adminController.middlewareAdminController, adminController.settingK3); // get info account
    ...
    router.post('/api/webapi/admin/updateMoney', adminController.middlewareAdminController, adminController.updateMoney); // get info account

    router.post('/api/webapi/admin/banned', adminController.middlewareAdminController, adminController.banned); // get info account
    router.post('/api/webapi/admin/deleted', adminController.middlewareAdminController, adminController.deleted);
